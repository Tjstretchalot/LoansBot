...
public class SiteSession {
	 ...
	 * @param userID which person this is a session for
	 * @param createdAt when this session was created
	 * @param expiresAt when this session should expire (-1 for never)
	 */
	public SiteSession(int id, String sessionIdentifier, int userID, Timestamp createdAt, Timestamp expiresAt) {
		super();
		this.id = id;
	...
	public boolean isValid() {
		return (sessionIdentifier != null && sessionIdentifier.length() < 255 && userID > 0 && createdAt != null);
	}
	...
	public String toString() {
		return "SiteSession [id=" + id + ", sessionIdentifier=" + (sessionIdentifier == null ? "null" : "<redacted not null>") + ", userID=" + userID
