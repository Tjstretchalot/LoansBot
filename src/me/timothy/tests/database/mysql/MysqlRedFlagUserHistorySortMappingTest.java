...
import me.timothy.tests.database.RedFlagUserHistorySortMappingTest;

public class MysqlRedFlagUserHistorySortMappingTest extends RedFlagUserHistorySortMappingTest {
	@Before
	public void setUp() {
