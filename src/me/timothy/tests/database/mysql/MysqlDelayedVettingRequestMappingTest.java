...
import me.timothy.tests.database.DelayedVettingRequestMappingTest;

public class MysqlDelayedVettingRequestMappingTest extends DelayedVettingRequestMappingTest {
	@Before
	public void setUp() {
